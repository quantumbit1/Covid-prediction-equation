...
for i=1:1:length(india_days)
    subplot(121)
    plot(india_days(1:i), india_total(1:i),'-m', 'LineWidth', 3)
...
for i=1:1:length(italy_days)
    subplot(122)
    plot(italy_days(1:i), italy_total(1:i), '-m','LineWidth', 3)
